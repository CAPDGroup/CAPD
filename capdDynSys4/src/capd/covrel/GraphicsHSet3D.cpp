...
void GraphicsHSet3D::show(krak::IFrame &f, int d1, int d2) const
{
...
void GraphicsHSet3D::show(krak::IFrame &f, int d1, int d2, const IntervalVector &iv, int color) const
{
  FloatVector A = M.column(d1) + M.column(d2);
  FloatVector B = -A;
  A=gauss(M,A);
...
void GraphicsHSet3D::show(krak::Coord3D &f) const
{
...
void GraphicsHSet3D::show(krak::Coord3D &f, const IntervalVector &v, int color) const
{
  show(f);
