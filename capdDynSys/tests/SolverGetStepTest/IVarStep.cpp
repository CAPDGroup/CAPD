...
BOOST_AUTO_TEST_SUITE(IVarStepSuite)
...
void dotest(TM& tm){
  ...
  tm.getSolver().turnOnStepControl();
}

BOOST_AUTO_TEST_CASE(C0C1_IVarStepTest)
{
...
BOOST_AUTO_TEST_CASE(C2_IVarStepTest)
{
  IMap f("var:x,y,z;fun:-y,x,z-x;");
...
BOOST_AUTO_TEST_CASE(Cn_IVarStepTest)
{
...
BOOST_AUTO_TEST_CASE(Fad_IVarStepTest)
{
