...
/**
  Sets the frame of the object to \e _frm . If the frame was NULL, the center
...
/**
   Sets the scale of the system to \e scale .
*/
...
/**
  Sets the foreground color of the attached frame to \e color . Put here for
  convenience.
*/
...
/**
  Sets the background color of the attached frame to \e color . Put here for
  convenience.
*/
...
/**
  ...
  to (\e i), \e j ) (in pixel coordinates 
*/
...
/**
  Jumps to the point \e pt . Changes also the current position of the
  attached frame.
*/
...
/**
  Jumps to the point (\e _x, \e _y , \e _z  ) . Changes also the current
...
/**
  Draws a dot at the position (\e x, \e y , \e z) . The current position is
  unaffected.
...
/**
  Draws a line from the current position the position (\e x), \e y , \e z  . The
...
/**
  Draws a line from the point (\e x1, \e y1 , \e z1 ) to (\e x2 , \e y2 , \e z2 ) .
...
/**
  Draws a box with a corner in (\e x1, \e y1 , \e z1 )  and
  and in (\e x2, \e y2 , \e z2). The edges are parallel to the axis.
  The current position is moved to (\e x2, \e y2 , \e z2 ).
...
/**
  Draw a cross with in the point (\e x), \e y , \e z   and
  and in (\e x2), \e y2 , \e z2  . The edges are parallel to the axis.
  The current position is moved to (\e x2), \e y2 , \e z2  .
...
/**
  Maps the 3D coordinates of the point (\e x), \e y , \e z   to the
...
/**
  ...
  <TABLE>
  <TR><TD>0</TD><TD>the \e z) axis is down (\e default  </TD></TR>
  <TR><TD>1</TD><TD>the \e z  axis is up</TD></TR>
  </TABLE>
*/
