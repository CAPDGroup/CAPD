...
namespace krak{
/**
    Waits for user action and retuns it in \a um
*/
...
/**
  Makes the rectangle \a r blink with the prescribed
  frequency and the prescribed colors until a user
  action returned in \a um
*/
...
/**
  Waits for user action and retuns it in \e (um)
*/
