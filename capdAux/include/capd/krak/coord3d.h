...
namespace krak{
  ...
  class. The \ref{IsomCoord3D} class implements
...
public:
  ...
  */
  ...
  /**
    ...
    Maps the 3D coordinates of the point \e p  to the
    frame pixel coordinates (this is a pure virtual function in Coord3D.
    Implemented in \ref IsomCoord3D::%top(IsomCoord3D))
  */
  ...
  */
  ...
  /**
    ...
    Draws a dot at the position (\e p). The current position is
    unaffected.
  ...
  */
  ...
  /**
    ...
    Draws a line from the current position the position (\e p). The
  ...
  */
  ...
  /**
    ...
    Draws a line from the point \e p1 to \e p2.
  ...
  */
  ...
  /**
    ...
    Draws a box with a corner in \e p1  and
    and in \e p2. The edges are parallel to the axis.
    The current position is moved to \e p2.
