...
template <class V,class MV> friend  V &_vmvsectassign(V &rv,const MV &v)
	...
	explicit INLINE l_imatrix_subv (l_interval *d, const int &l, const int &u, const int &s, const int &st, const int &o):dat(d),lb(l),ub(u),size(s),start(st),offset(o) { }
	public:
	//! Constructor of class l_imatrix_subv
	INLINE l_imatrix_subv(const l_imatrix_subv &v):dat(v.dat),lb(v.lb),ub(v.ub),size(v.size),start(v.start),offset(v.offset) { }
	public:

	//---------------------- Standardfunktionen ------------------------

	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_imatrix_subv &rv);
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_interval &r);
	//! Implementation of standard assigning operator
	...
	// Real
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const real &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const rmatrix_subv &rv);

	// l_real
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_real &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_rmatrix_subv &rv);

	// interval
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const interval &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const imatrix_subv &rv);

	//! Returns the lower bound of the vector
	friend INLINE int Lb(const l_imatrix_subv &rv) { return rv.lb; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const l_imatrix_subv &rv) { return rv.ub; }
	...
	INLINE l_imatrix_subv &operator ()() { return *this; }
	...
	INLINE l_imatrix_subv &operator *=(const l_interval &c);
	...
	// real
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_subv &operator *=(const real &c);
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_subv &operator +=(const real &c);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_subv &operator -=(const real &c);
	...
	// l_real
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_subv &operator *=(const l_real &c);
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_subv &operator +=(const l_real &c);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_subv &operator -=(const l_real &c);
	...
	// interval
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_subv &operator *=(const interval &c);
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_subv &operator +=(const interval &c);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_subv &operator -=(const interval &c);
...
// l_interval
	...
	INLINE l_imatrix(const l_imatrix &rm);
	//! Constructor of class l_imatrix
	INLINE l_imatrix(const l_imatrix_slice &rm);
	//! Constructor of class l_imatrix
	INLINE l_imatrix();
	//! Constructor of class l_imatrix
...
#endif
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_ivector &v);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_ivector_slice &v);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_interval &r);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_interval &r);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_imatrix &m);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_imatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_ivector &v);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_ivector_slice &v);
//  real
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const real &r);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rmatrix &rm);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rmatrix_slice &rm);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rvector &v);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rvector_slice &v);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const real &r);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rmatrix &m);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rvector &v);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rvector_slice &v);

//  l_real
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_real &r);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rmatrix &rm);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rmatrix_slice &rm);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rvector &v);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rvector_slice &v);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_real &r);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rmatrix &m);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rvector &v);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rvector_slice &v);

//  interval
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const interval &r);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const imatrix &rm);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const imatrix_slice &rm);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const ivector &v);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const ivector_slice &v);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const interval &r);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const imatrix &m);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const imatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const ivector &v);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const ivector_slice &v);

	//--------------------------- Destruktoren -----------------------------

	INLINE ~l_imatrix() { delete [] dat; }
	...
	INLINE l_imatrix &operator ()() { return *this; }
...
template <class V,class MS,class S> friend  void _vmsconstr(V &v,const MS &m)
 ...
 template <class MS> friend 	std::istream &_msin(std::istream &s,MS &r);
	...
	explicit INLINE l_imatrix_slice(l_imatrix &a,const int &l1,const int &u1,const int &l2, const int &u2):dat(a.dat),offset1(l1-a.lb1),offset2(l2-a.lb2),mxsize(a.xsize),mysize(a.ysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	//! Constructor of class l_imatrix_slice
	explicit INLINE l_imatrix_slice(l_imatrix_slice &a,const int &l1,const int &u1,const int &l2, const int &u2):dat(a.dat),offset1(a.offset1+l1-a.start1),offset2(a.offset2+l2-a.start2),mxsize(a.mxsize),mysize(a.mysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	public: 
	//! Constructor of class l_imatrix_slice
	INLINE l_imatrix_slice(const l_imatrix_slice &ms):dat(ms.dat),offset1(ms.offset1),offset2(ms.offset2),mxsize(ms.mxsize),mysize(ms.mysize),start1(ms.start1),end1(ms.end1),start2(ms.start2),end2(ms.end2),sxsize(ms.sxsize),sysize(ms.sysize) { }
	public:
	...
	;
#endif
	friend INLINE l_imatrix::l_imatrix(const l_imatrix_slice &);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const l_interval &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const real &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const interval &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const l_real &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Operator for accessing the whole matrix
	INLINE l_imatrix_slice &operator ()() { return *this; }
	//! Operator for accessing a part of the matrix
	INLINE l_imatrix_slice operator ()(const int &m, const int &n)
#if(CXSC_INDEX_CHECK)
	;
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const l_interval &c);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const l_interval &c);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const l_interval &c);
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const real &c);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const real &c);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const real &c);
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const l_real &c);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const l_real &c);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const l_real &c);
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const interval &c);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const interval &c);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const interval &c);
...
//=======================Vector / Scalar =========================
	...
	INLINE l_ivector operator /(const l_imatrix_subv &rv, const l_interval &s);
	//! Implementation of multiplication operation
	INLINE l_ivector operator *(const l_imatrix_subv &rv, const l_interval &s);
	//! Implementation of multiplication operation
	INLINE l_ivector operator *(const l_interval &s, const l_imatrix_subv &rv);
	//! Returns the absolute value of the matrix
	INLINE l_ivector abs(const l_imatrix_subv &mv);
	//! Returns the rounded diameter of the matrix
	INLINE l_rvector diam(const l_imatrix_subv &mv);
	//! Returns the rounded middle of the matrix
	INLINE l_rvector mid(const l_imatrix_subv &mv);
	//! Returns the infimum of the matrix
	INLINE l_rvector Inf(const l_imatrix_subv &mv);
	//! Returns the supremum of the matrix
	INLINE l_rvector Sup(const l_imatrix_subv &mv);
	...
	//! Returns the matrix with the new given supremum value
	INLINE l_imatrix_subv &SetSup(l_imatrix_subv &iv,const l_real &r);
	//! Returns the matrix with the new given infimum value
	INLINE l_imatrix_subv &SetInf(l_imatrix_subv &iv,const l_real &r);
	//! Returns the matrix with the new unchecked given supremum value
	INLINE l_imatrix_subv &UncheckedSetSup(l_imatrix_subv &iv,const l_real &r);
	//! Returns the matrix with the new unchecked given infimum value
	INLINE l_imatrix_subv &SetUncheckedInf(l_imatrix_subv &iv,const l_real &r);
...
//===================== Matrix Functions =============================
	...
	INLINE l_imatrix _imatrix(const l_imatrix &rm);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_imatrix _imatrix(const l_ivector &v);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_imatrix _imatrix(const l_ivector_slice &v);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_imatrix _imatrix(const l_interval &r);
...
#endif
	//! Resizes the matrix
	INLINE void Resize(l_imatrix &A);
	//! Resizes the matrix
	...
	//! Returns the absolute value of the matrix
	INLINE l_imatrix abs(const l_imatrix &m);
	//! Returns the absolute value of the matrix
	INLINE l_imatrix abs(const l_imatrix_slice &ms);
	//! Returns the rounded diameter of the matrix
	INLINE l_rmatrix diam(const l_imatrix &m);
	//! Returns the rounded diameter of the matrix
	INLINE l_rmatrix diam(const l_imatrix_slice &m);
	//! Returns the rounded middle of the matrix
	INLINE l_rmatrix mid(const l_imatrix &m);
	//! Returns the rounded middle of the matrix
	INLINE l_rmatrix mid(const l_imatrix_slice &m);
	//! Returns the infimum of the matrix
	INLINE l_rmatrix Inf(const l_imatrix &m);
	//! Returns the supremum of the matrix
	INLINE l_rmatrix Sup(const l_imatrix &m);
	//! Returns the infimum of the matrix
	INLINE l_rmatrix Inf(const l_imatrix_slice &m);
	//! Returns the supremum of the matrix
	INLINE l_rmatrix Sup(const l_imatrix_slice &m);
	//! Returns the matrix with the new given infimum value
...
//===================== Matrix / Scalar ===============================
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_imatrix &m);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_imatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const l_interval &c);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const l_interval &c);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const l_interval &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const l_interval &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const l_interval &c);
...
//------------ real - l_imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const real &c, const l_imatrix &m);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const real &c, const l_imatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const real &c);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const real &c);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const real &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const real &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const real &c);
...
//----------------- rmatrix - l_interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const rmatrix &m);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const rmatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const rmatrix &m,const l_interval &c);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const rmatrix_slice &ms,const l_interval &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const rmatrix &m,const l_interval &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const rmatrix_slice &ms, const l_interval &c);
...
//------------ l_real - l_imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_real &c, const l_imatrix &m);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_real &c, const l_imatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const l_real &c);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const l_real &c);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const l_real &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const l_real &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const l_real &c);
...
//----------------- l_rmatrix - l_interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_rmatrix &m);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_rmatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_rmatrix &m,const l_interval &c);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_rmatrix_slice &ms,const l_interval &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_rmatrix &m,const l_interval &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_rmatrix_slice &ms, const l_interval &c);
...
//------------ interval - l_imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const interval &c, const l_imatrix &m);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const interval &c, const l_imatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const interval &c);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const interval &c);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const interval &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const interval &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const interval &c);
...
//----------------- imatrix - l_interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const imatrix &m);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const imatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const imatrix &m,const l_interval &c);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const imatrix_slice &ms,const l_interval &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const imatrix &m,const l_interval &c);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const imatrix_slice &ms, const l_interval &c);
...
//================ Matrix / Matrix ============================
	...
	INLINE const l_imatrix &operator +(const l_imatrix &m1);
	//! Implementation of positive sign operation
	INLINE l_imatrix operator +(const l_imatrix_slice &ms);
	//! Implementation of addition operation
...
//-------------- Matrix - Matrix   -------------------------
	...
	INLINE bool operator ==(const l_imatrix &m1,const l_imatrix &m2);
	...
	INLINE bool operator >=(const l_imatrix &m1,const l_imatrix &m2);
	//! Implementation of standard equality operation
	INLINE bool operator ==(const l_imatrix &m1,const l_imatrix_slice &ms);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const l_imatrix &m1,const l_imatrix_slice &ms);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const l_imatrix &m1,const l_imatrix_slice &ms);
...
//---------------- Matrix - Matrix_slice ----------------------
	...
	//! Implementation of standard equality operation
	INLINE bool operator ==(const l_imatrix_slice &m1,const l_imatrix_slice &m2);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const l_imatrix_slice &m1,const l_imatrix_slice &m2);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const l_imatrix_slice &m1,const l_imatrix_slice &m2);
...
//=================== Not Operator =============================
	...
	INLINE bool operator !(const l_imatrix &ms);
	//! Implementation of standard negation operation
	INLINE bool operator !(const l_imatrix_slice &ms);

//======================== Input / Output ========================

	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const l_imatrix &r);
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const l_imatrix_slice &r);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,l_imatrix &r);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,l_imatrix_slice &r);
