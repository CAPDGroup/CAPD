...
namespace cxsc {
	...
	INLINE l_ivector::l_ivector(const l_rmatrix_subv &v):l(v.lb),u(v.ub),size(v.size)
	{
	...
	*/
	...
	INLINE l_ivector &l_ivector::operator =(const l_rmatrix_subv &mv) { return _vmvassign<l_ivector,l_rmatrix_subv,l_interval>(*this,mv); }
	INLINE l_ivector_slice &l_ivector_slice::operator =(const l_rmatrix_subv &mv) { return _vsvassign(*this,l_rvector(mv)); }
