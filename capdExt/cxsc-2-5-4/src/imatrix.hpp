...
template <class V,class MV> friend  V &_vmvsetre(V &rv,const MV &v)
  ...
  */
	...
	explicit INLINE imatrix_subv (interval *d, const int &l, const int &u, const int &s, const int &st, const int &o):dat(d),lb(l),ub(u),size(s),start(st),offset(o) { }
        public:
	//! Constructor of class imatrix_subv
	INLINE imatrix_subv(const imatrix_subv &v):dat(v.dat),lb(v.lb),ub(v.ub),size(v.size),start(v.start),offset(v.offset) { }
	public:
	...
	//! Implementation of standard assigning operator
	INLINE imatrix_subv &operator =(const imatrix_subv &rv);
	//! Implementation of standard assigning operator
	INLINE imatrix_subv &operator =(const interval &r);
	//! Implementation of standard assigning operator
	...
	// Real
	//! Implementation of standard assigning operator
	INLINE imatrix_subv &operator =(const rmatrix_subv &rv);
	//! Implementation of standard assigning operator
	INLINE imatrix_subv &operator =(const real &r);
	//! Implementation of standard assigning operator
	...
	friend INLINE int Lb(const imatrix_subv &rv) { return rv.lb; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const imatrix_subv &rv) { return rv.ub; }
	//! Returns the size of the vector
	friend INLINE int VecLen(const imatrix_subv &rv) { return rv.size; }
	...
	INLINE imatrix_subv &operator ()() { return *this; }
	...
	INLINE imatrix_subv &operator *=(const interval &c);
	...
	// real
	//! Implementation of multiplication and allocation operation
	INLINE imatrix_subv &operator *=(const real &c);
	//! Implementation of addition and allocation operation
	INLINE imatrix_subv &operator +=(const real &c);
	//! Implementation of subtraction and allocation operation
	INLINE imatrix_subv &operator -=(const real &c);
...
// interval
	...
	INLINE imatrix(const imatrix &rm);
	//! Constructor of class imatrix
	INLINE imatrix(const imatrix_slice &rm);
	//! Constructor of class imatrix
...
#endif
	//! Constructor of class imatrix
	explicit INLINE imatrix(const ivector &v);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const ivector_slice &v);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const interval &r);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const interval &r);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const imatrix &m);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const imatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const simatrix &m);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const simatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const ivector &v);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const ivector_slice &v);
//  real
	//! Constructor of class imatrix
	explicit INLINE imatrix(const real &r);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const rmatrix &rm);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const rmatrix_slice &rm);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const srmatrix &rm);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const srmatrix_slice &rm);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const rvector &v);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const rvector_slice &v);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const real &r);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const rmatrix &m);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const rmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const srmatrix &m);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const srmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const rvector &v);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const rvector_slice &v);

	//--------------------------- Destruktoren -----------------------------

	INLINE ~imatrix() { delete [] dat; }
	...
	INLINE imatrix &operator ()() { return *this; }
...
template <class V,class MS,class S> friend  void _vmsconstr(V &v,const MS &m)
 ...
 template <class V,class MS,class S> friend 	 V &_vmslimultassign(V &v,const MS &ms)
  ...
  /*   friend TINLINE l_ivector &_vsmslimultassign<l_ivector_slice,imatrix_slice,l_interval>(l_ivector_slice &v,const imatrix_slice &m)
	...
	explicit INLINE imatrix_slice(imatrix &a,const int &l1,const int &u1,const int &l2, const int &u2):dat(a.dat),offset1(l1-a.lb1),offset2(l2-a.lb2),mxsize(a.xsize),mysize(a.ysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	//! Constructor of class imatrix_slice
	explicit INLINE imatrix_slice(imatrix_slice &a,const int &l1,const int &u1,const int &l2, const int &u2):dat(a.dat),offset1(a.offset1+l1-a.start1),offset2(a.offset2+l2-a.start2),mxsize(a.mxsize),mysize(a.mysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	public: 
	//! Constructor of class imatrix_slice
        INLINE imatrix_slice(const imatrix_slice &ms):dat(ms.dat),offset1(ms.offset1),offset2(ms.offset2),mxsize(ms.mxsize),mysize(ms.mysize),start1(ms.start1),end1(ms.end1),start2(ms.start2),end2(ms.end2),sxsize(ms.sxsize),sysize(ms.sysize) { }
	public:
	...
	;
#endif
	friend INLINE imatrix::imatrix(const imatrix_slice &);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE imatrix_slice &operator =(const interval &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE imatrix_slice &operator =(const real &r);
	//! Implementation of standard assigning operator
	...
	//! Operator for accessing the whole matrix
	INLINE imatrix_slice &operator ()() { return *this; }
	//! Operator for accessing a part of the matrix
	INLINE imatrix_slice operator ()(const int &m, const int &n)
#if(CXSC_INDEX_CHECK)
	;
...
#endif
	//! Implementation of multiplication and allocation operation
	INLINE imatrix_slice &operator *=(const interval &c);
	//! Implementation of multiplication and allocation operation
	INLINE imatrix_slice &operator *=(const real &c);
	//! Implementation of division and allocation operation
	INLINE imatrix_slice &operator /=(const interval &c);
	//! Implementation of division and allocation operation
	INLINE imatrix_slice &operator /=(const real &c);
...
//=======================Vector / Scalar =========================
	...
	INLINE ivector operator /(const imatrix_subv &rv, const interval &s);
	//! Implementation of multiplication operation
	INLINE ivector operator *(const imatrix_subv &rv, const interval &s);
	//! Implementation of multiplication operation
	INLINE ivector operator *(const interval &s, const imatrix_subv &rv);
	//! Returns the absolute value of the matrix
	INLINE ivector abs(const imatrix_subv &mv);
	...
	INLINE rvector diam(const imatrix_subv &mv);
	//! Returns the rounded middle of the matrix
	INLINE rvector mid(const imatrix_subv &mv);
	//! Returns the infimum of the matrix
	INLINE rvector Inf(const imatrix_subv &mv);
	//! Returns the supremum of the matrix
	INLINE rvector Sup(const imatrix_subv &mv);
...
#endif
	//! Returns the matrix with the new given supremum value
	INLINE imatrix_subv &SetSup(imatrix_subv &iv,const real &r);
	//! Returns the matrix with the new given infimum value
	INLINE imatrix_subv &SetInf(imatrix_subv &iv,const real &r);
	//! Returns the matrix with the new unchecked given supremum value
	INLINE imatrix_subv &UncheckedSetSup(imatrix_subv &iv,const real &r);
	//! Returns the matrix with the new unchecked given infimum value
	INLINE imatrix_subv &SetUncheckedInf(imatrix_subv &iv,const real &r);
...
//===================== Matrix Functions =============================
	...
	INLINE imatrix _imatrix(const imatrix &rm);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE imatrix _imatrix(const ivector &v);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE imatrix _imatrix(const ivector_slice &v);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE imatrix _imatrix(const interval &r);
	...
	//! Returns the absolute value of the matrix
	INLINE imatrix abs(const imatrix_slice &ms);
	//! Returns the absolute minimum value of the matrix
	INLINE rmatrix absmin(const imatrix_slice &ms);
	//! Returns the absolute maximum value of the matrix
	INLINE rmatrix absmax(const imatrix_slice &ms);
	//! Returns the rounded diameter of the matrix
	INLINE rmatrix diam(const imatrix &m);
	//! Returns the rounded diameter of the matrix
	INLINE rmatrix diam(const imatrix_slice &ms);
	//! Returns the rounded middle of the matrix
	INLINE rmatrix mid(const imatrix &m);
	//! Returns the rounded middle of the matrix
	INLINE rmatrix mid(const imatrix_slice &ms);
	//! Returns the infimum of the matrix
	INLINE rmatrix Inf(const imatrix &m);
	//! Returns the supremum of the matrix
	INLINE rmatrix Sup(const imatrix &m);
	//! Returns the infimum of the matrix
	INLINE rmatrix Inf(const imatrix_slice &m);
	//! Returns the supremum of the matrix
	INLINE rmatrix Sup(const imatrix_slice &m);
	//! Returns the matrix with the new given infimum value
...
//===================== Matrix / Scalar ===============================
	...
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const interval &c, const imatrix &m);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const interval &c, const imatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const imatrix &m,const interval &c);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const imatrix_slice &ms,const interval &c);
	//! Implementation of multiplication and allocation operation
	INLINE imatrix &operator *=(imatrix &m,const interval &c);
	//! Implementation of division operation
	INLINE imatrix operator /(const imatrix &m,const interval &c);
	//! Implementation of division operation
	INLINE imatrix operator /(const imatrix_slice &ms, const interval &c);
...
//------------ real - imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const real &c, const imatrix &m);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const real &c, const imatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const imatrix &m,const real &c);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const imatrix_slice &ms,const real &c);
	//! Implementation of multiplication and allocation operation
	INLINE imatrix &operator *=(imatrix &m,const real &c);
	//! Implementation of division operation
	INLINE imatrix operator /(const imatrix &m,const real &c);
	//! Implementation of division operation
	INLINE imatrix operator /(const imatrix_slice &ms, const real &c);
...
//----------------- rmatrix - interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const interval &c, const rmatrix &m);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const interval &c, const rmatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const rmatrix &m,const interval &c);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const rmatrix_slice &ms,const interval &c);
	//! Implementation of division operation
	INLINE imatrix operator /(const rmatrix &m,const interval &c);
	//! Implementation of division operation
	INLINE imatrix operator /(const rmatrix_slice &ms, const interval &c);
...
//================ Matrix / Matrix ============================
	...
	INLINE const imatrix &operator +(const imatrix &m1);
	//! Implementation of positive sign operation
	INLINE imatrix operator +(const imatrix_slice &ms);
	//! Implementation of addition operation
...
//-------------- Matrix - Matrix   -------------------------
	...
	INLINE bool operator >=(const imatrix &m1,const imatrix &m2);
	//! Implementation of standard equality operation
	INLINE bool operator ==(const imatrix &m1,const imatrix_slice &ms);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const imatrix &m1,const imatrix_slice &ms);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const imatrix &m1,const imatrix_slice &ms);
...
//---------------- Matrix - Matrix_slice ----------------------
	...
	//! Implementation of standard equality operation
	INLINE bool operator ==(const imatrix_slice &m1,const imatrix_slice &m2);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const imatrix_slice &m1,const imatrix_slice &m2);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const imatrix_slice &m1,const imatrix_slice &m2);
...
//=================== Not Operator =============================
	...
	INLINE bool operator !(const imatrix &ms);
	//! Implementation of standard negation operation
	INLINE bool operator !(const imatrix_slice &ms);

//======================== Input / Output ========================

	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const imatrix &r);
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const imatrix_slice &r);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,imatrix &r);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,imatrix_slice &r);
