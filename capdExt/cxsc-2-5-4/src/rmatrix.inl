...
INLINE rmatrix::rmatrix():dat(NULL),lb1(1),ub1(0),lb2(1),ub2(0),xsize(0),ysize(0)
{
}

INLINE rmatrix::rmatrix(const real &r):lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new real[1];
	*dat=r;
}

INLINE rmatrix::rmatrix(const rmatrix &rm):lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
...
INLINE rvector::rvector(const rmatrix_subv &v):l(v.lb),u(v.ub),size(v.size)
{
	dat=new real[size];
...
INLINE rmatrix::rmatrix(const rvector &v):lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new real[v.size];
...
INLINE rmatrix::rmatrix(const rvector_slice &v):lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new real[v.size];
	...
	INLINE rmatrix::rmatrix(const rmatrix_slice &sl):lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
...
// the following is generated from .hpp
	...
	INLINE rmatrix_subv &rmatrix_subv::operator =(const rmatrix_subv &rv) { return _mvmvassign(*this,rv); }
	INLINE rmatrix_subv &rmatrix_subv::operator =(const real &r) { return _mvsassign(*this,r); }
	...
	INLINE rmatrix &rmatrix::operator =(const real &r) { return _msassign(*this,r); }
	INLINE rmatrix &rmatrix::operator =(const rmatrix &m) { return _mmassign<rmatrix,rmatrix,real>(*this,m,0); }
	INLINE rmatrix &rmatrix::operator =(const rvector &v) { return _mvassign<rmatrix,rvector,real>(*this,v); }
	INLINE rmatrix &rmatrix::operator =(const rvector_slice &v) { return _mvassign<rmatrix,rvector,real>(*this,rvector(v)); }
	INLINE rmatrix::operator void*() { return _mvoid(*this); }
	...
	INLINE rmatrix_slice &rmatrix_slice::operator =(const real &r) { return _mssassign(*this,r); }
...
#endif
	{ return (*this=*this*m); }
	INLINE rmatrix_slice &rmatrix_slice::operator *=(const real &c) { return _mssmultassign(*this,c); }
	INLINE rmatrix_slice &rmatrix_slice::operator /=(const real &c) { return _mssdivassign(*this,c); }
	INLINE rmatrix_slice::operator void*() { return _msvoid(*this); }
	INLINE rvector operator /(const rmatrix_subv &rv, const real &s) { return _mvsdiv<rmatrix_subv,real,rvector>(rv,s); }
	INLINE rvector operator *(const rmatrix_subv &rv, const real &s) { return _mvsmult<rmatrix_subv,real,rvector>(rv,s); }
	INLINE rvector operator *(const real &s, const rmatrix_subv &rv) { return _mvsmult<rmatrix_subv,real,rvector>(rv,s); }
	INLINE rmatrix_subv &rmatrix_subv::operator *=(const real &c) { return _mvsmultassign(*this,c); }
	INLINE rmatrix_subv &rmatrix_subv::operator +=(const real &c) { return _mvsplusassign(*this,c); }
	INLINE rmatrix_subv &rmatrix_subv::operator -=(const real &c) { return _mvsminusassign(*this,c); }
	INLINE rmatrix_subv &rmatrix_subv::operator /=(const real &c) { return _mvsdivassign(*this,c); }
	INLINE rvector abs(const rmatrix_subv &mv) { return _mvabs<rmatrix_subv,rvector>(mv); }
	INLINE rvector &rvector::operator =(const rmatrix_subv &mv) { return _vmvassign<rvector,rmatrix_subv,real>(*this,mv); }
	INLINE rvector_slice &rvector_slice::operator =(const rmatrix_subv &mv) { return _vsvassign(*this,rvector(mv)); }
	...
	*/
	INLINE rmatrix _rmatrix(const rmatrix &rm) { return rm; }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::rmatrix::rmatrix(const rvector &v)
	*/
	INLINE rmatrix _rmatrix(const rvector &v) { return rmatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::rmatrix::rmatrix(const rvector_slice &v)
	*/
	INLINE rmatrix _rmatrix(const rvector_slice &v) { return rmatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::rmatrix::rmatrix(const real &r)
	*/
	INLINE rmatrix _rmatrix(const real &r) { return rmatrix(r); }
	INLINE rmatrix &rmatrix::operator =(const rmatrix_slice &ms) { return _mmsassign<rmatrix,rmatrix_slice,real>(*this,ms); }
	...
	INLINE void Resize(rmatrix &A) { _mresize(A); }
	...
	INLINE rmatrix abs(const rmatrix &m) { return _mabs<rmatrix,rmatrix>(m); }
	INLINE rmatrix abs(const rmatrix_slice &ms) { return _msabs<rmatrix_slice,rmatrix>(ms); }
...
#endif
	{ _smconstr(*this,m); }
//	INLINE real real::_real(const rmatrix &m) { _smconstr(*this,m); return *this; }
	INLINE rmatrix operator *(const real &c, const rmatrix &m) { return _smmult<real,rmatrix,rmatrix>(c,m); }
	INLINE rmatrix operator *(const real &c, const rmatrix_slice &ms) { return _smsmult<real,rmatrix_slice,rmatrix>(c,ms); }
	INLINE rmatrix operator *(const rmatrix &m,const real &c) { return _smmult<real,rmatrix,rmatrix>(c,m); }
	INLINE rmatrix operator *(const rmatrix_slice &ms,const real &c) { return _smsmult<real,rmatrix_slice,rmatrix>(c,ms); }
	INLINE rmatrix &operator *=(rmatrix &m,const real &c) { return _msmultassign(m,c); }
	INLINE rmatrix operator /(const rmatrix &m,const real &c) { return _msdiv<rmatrix,real,rmatrix>(m,c); }
	INLINE rmatrix operator /(const rmatrix_slice &ms, const real &c) { return _mssdiv<rmatrix_slice,real,rmatrix>(ms,c); }
	INLINE rmatrix &operator /=(rmatrix &m,const real &c) { return _msdivassign(m,c); }
	...
	INLINE const rmatrix &operator +(const rmatrix &m) { return m; }
	INLINE rmatrix operator +(const rmatrix_slice &m) { return rmatrix(m); }
	...
	INLINE rmatrix operator -(const rmatrix &m) { return _mminus(m); }
	INLINE rmatrix operator -(const rmatrix_slice &m) { return _msminus<rmatrix_slice,rmatrix>(m); }
	INLINE rmatrix operator -(const rmatrix &m1,const rmatrix &m2)
#if(CXSC_INDEX_CHECK)
	...
	INLINE bool operator ==(const rmatrix &m1,const rmatrix &m2) { return _mmeq(m1,m2); }
	INLINE bool operator !=(const rmatrix &m1,const rmatrix &m2) { return _mmneq(m1,m2); }
	INLINE bool operator <(const rmatrix &m1,const rmatrix &m2) { return _mmless(m1,m2); }
	INLINE bool operator <=(const rmatrix &m1,const rmatrix &m2) { return _mmleq(m1,m2); }
	INLINE bool operator >(const rmatrix &m1,const rmatrix &m2) { return _mmless(m2,m1); }
	INLINE bool operator >=(const rmatrix &m1,const rmatrix &m2) { return _mmleq(m2,m1); }
	INLINE bool operator ==(const rmatrix &m1,const rmatrix_slice &ms) { return _mmseq(m1,ms); }
	INLINE bool operator !=(const rmatrix &m1,const rmatrix_slice &ms) { return _mmsneq(m1,ms); }
	INLINE bool operator <(const rmatrix &m1,const rmatrix_slice &ms) { return _mmsless(m1,ms); }
	INLINE bool operator <=(const rmatrix &m1,const rmatrix_slice &ms) { return _mmsleq(m1,ms); }
	INLINE bool operator >(const rmatrix &m1,const rmatrix_slice &ms) { return _msmless(ms,m1); }
	INLINE bool operator >=(const rmatrix &m1,const rmatrix_slice &ms) { return _msmleq(ms,m1); }
	INLINE bool operator ==(const rmatrix_slice &m1,const rmatrix_slice &m2) { return _msmseq(m1,m2); }
	INLINE bool operator !=(const rmatrix_slice &m1,const rmatrix_slice &m2) { return _msmsneq(m1,m2); }
	INLINE bool operator <(const rmatrix_slice &m1,const rmatrix_slice &m2) { return _msmsless(m1,m2); }
	INLINE bool operator <=(const rmatrix_slice &m1,const rmatrix_slice &m2) { return _msmsleq(m1,m2); }
	INLINE bool operator >(const rmatrix_slice &m1,const rmatrix_slice &m2) { return _msmsless(m2,m1); }
	INLINE bool operator >=(const rmatrix_slice &m1,const rmatrix_slice &m2) { return _msmsleq(m2,m1); }
	INLINE bool operator !(const rmatrix &ms) { return _mnot(ms); }
	INLINE bool operator !(const rmatrix_slice &ms) { return _msnot(ms); }
	INLINE std::ostream &operator <<(std::ostream &s,const rmatrix &r) { return _mout(s,r); }
	INLINE std::ostream &operator <<(std::ostream &s,const rmatrix_slice &r) { return _msout(s,r); }
	INLINE std::istream &operator >>(std::istream &s,rmatrix &r) { return _min(s,r); }
	INLINE std::istream &operator >>(std::istream &s,rmatrix_slice &r) { return _msin(s,r); }
