...
// Liefert u,v f�r: x2 = u + v; EXAKTE Darstellung, falls kein overflow 
// auftritt und v im normalisierten Bereich liegt. u > |v|
// Vorsicht: Funktioniert zun�chst nur auf INTEL-Systemen!!!
{
    real a,b,t,y1,y2;
    a = Cut26(x);
    b = x-a;  // x = a+b;
...
{    const real c1 = 1.000732421875, 
	...
	x2 = x1*x1;  ep = x2-1;
	res = sqrt(ep+ep2); // res ist Startwert f�r Newton-Verfahren
...
real Cut24(const real& x){
    ...
    // von x �bereinstimmt, das hidden bit ist dabei mitgez�hlt!
