...
l_complex sqrt(const l_complex&, int);
//! Calculates an approximation of \f$ \mbox{arg}(z) \f$
l_real arg(const l_complex&);
//! Calculates an approximation of \f$ \mbox{arg}(z) \f$
l_real Arg(const l_complex&);
...
l_complex ln(const l_complex&);
//! Calculates an approximation of \f$ \ln(1+z) \f$
l_complex lnp1(const l_complex&);
//! Calculates an approximation of \f$ \mbox{log2}(z) \f$
l_complex log2(const l_complex&);
//! Calculates an approximation of \f$ \mbox{log10}(z) \f$
l_complex log10(const l_complex&);
//! Calculates an approximation of \f$ z^n \f$
l_complex power(const l_complex&, int);
//! Calculates an approximation of \f$ z^n \f$
l_complex power_fast(const l_complex&, int);
//! Calculates an approximation of \f$ z^y \f$
l_complex pow(const l_complex&, const l_real&);
//! Calculates an approximation of \f$ z_1^{z_2} \f$
l_complex pow(const l_complex&, const l_complex&);
