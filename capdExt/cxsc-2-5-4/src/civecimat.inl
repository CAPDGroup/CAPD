...
namespace cxsc {
	...
	INLINE civector::civector(const imatrix_subv &v):l(v.lb),u(v.ub),size(v.size)
	{
	...
	INLINE civector &civector::operator =(const imatrix_subv &mv) { return _vmvassign<civector,imatrix_subv,cinterval>(*this,mv); }
	INLINE civector_slice &civector_slice::operator =(const imatrix_subv &mv) { return _vsvassign(*this,ivector(mv)); }
