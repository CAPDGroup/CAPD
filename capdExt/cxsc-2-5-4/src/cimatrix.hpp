...
template <class MV,class V> friend  V _mvsup(const MV &mv);
 ...
 template <class MV,class S> friend 	 MV &_mvssetinf(MV &mv, const S &s);
 template <class MV,class S> friend 	 MV &_mvssetsup(MV &mv, const S &s);
 template <class MV,class S> friend 	 MV &_mvsusetinf(MV &mv, const S &s);
 template <class MV,class S> friend 	 MV &_mvsusetsup(MV &mv, const S &s);
 template <class MV,class S> friend 	 MV &_mvssetim(MV &mv, const S &s);
 template <class MV,class S> friend 	 MV &_mvssetre(MV &mv, const S &s);
...
template <class V,class MV> friend  V &_vmvsectassign(V &rv,const MV &v)
	...
	explicit INLINE cimatrix_subv (cinterval *d, const int &l, const int &u, const int &s, const int &st, const int &o):dat(d),lb(l),ub(u),size(s),start(st),offset(o) { }
        public:
	//! Constructor of class cimatrix_subv
	INLINE cimatrix_subv(const cimatrix_subv &v):dat(v.dat),lb(v.lb),ub(v.ub),size(v.size),start(v.start),offset(v.offset) { }
	public:
	...
	//! Implementation of standard assigning operator
	cimatrix_subv &operator =(const cimatrix_subv &rv);
	//! Implementation of standard assigning operator
	cimatrix_subv &operator =(const cinterval &r);
	//! Implementation of standard assigning operator
	...
	// Real
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const real &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const rmatrix_subv &rv);

	// complex
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const complex &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const cmatrix_subv &rv);

	// interval
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const interval &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const imatrix_subv &rv);

	//! Returns the lower bound of the vector
	friend INLINE int Lb(const cimatrix_subv &rv) { return rv.lb; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const cimatrix_subv &rv) { return rv.ub; }
	//! Returns the size of the vector
	friend INLINE int VecLen(const cimatrix_subv &rv) { return rv.size; }
	...
	INLINE cimatrix_subv &operator ()() { return *this; }
	...
	INLINE cimatrix_subv &operator *=(const cinterval &c);
	...
	// real
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_subv &operator *=(const real &c);
	//! Implementation of addition and allocation operation
	INLINE cimatrix_subv &operator +=(const real &c);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_subv &operator -=(const real &c);
	...
	// complex
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_subv &operator *=(const complex &c);
	//! Implementation of addition and allocation operation
	INLINE cimatrix_subv &operator +=(const complex &c);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_subv &operator -=(const complex &c);
	...
	// interval
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_subv &operator *=(const interval &c);
	//! Implementation of addition and allocation operation
	INLINE cimatrix_subv &operator +=(const interval &c);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_subv &operator -=(const interval &c);
...
template <class M,class V,class S> friend  M &_mvassign(M &m,const V &v);
 ...
 template <class M,class E> friend 	 E _mre(const M &m);
 template <class M,class E> friend 	 E _mim(const M &m);
	friend INLINE rmatrix SupRe(const cimatrix &v);
	friend INLINE rmatrix SupIm(const cimatrix &v);
	friend INLINE rmatrix InfRe(const cimatrix &v);
	friend INLINE rmatrix InfIm(const cimatrix &v);
...
// cinterval
	...
	INLINE cimatrix(const cimatrix &rm);
	//! Constructor of class cimatrix
	INLINE cimatrix(const cimatrix_slice &rm);
	//! Constructor of class cimatrix
...
#endif
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const civector &v);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const civector_slice &v);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cinterval &r);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cinterval &r);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cimatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cimatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scimatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scimatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const civector &v);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const civector_slice &v);
//  real
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const real &r);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rmatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rmatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const srmatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const srmatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rvector &v);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rvector_slice &v);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const real &r);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rmatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const srmatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const srmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rvector &v);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rvector_slice &v);

//  complex
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const complex &r);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cmatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cmatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const scmatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const scmatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cvector &v);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cvector_slice &v);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const complex &r);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cmatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scmatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cvector &v);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cvector_slice &v);

//  interval
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const interval &r);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const imatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const imatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const simatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const simatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const ivector &v);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const ivector_slice &v);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const interval &r);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const imatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const imatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const simatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const simatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const ivector &v);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const ivector_slice &v);

	//--------------------------- Destruktoren -----------------------------

	INLINE ~cimatrix() { delete [] dat; }
	...
	INLINE cimatrix &operator ()() { return *this; }
...
template <class V,class MS,class S> friend  void _vmsconstr(V &v,const MS &m)
 ...
 template <class MS,class E> friend 	 E _msre(const MS &ms);
 template <class MS,class E> friend 	 E _msim(const MS &ms);
	friend INLINE rmatrix SupRe(const cimatrix_slice &v);
	friend INLINE rmatrix SupIm(const cimatrix_slice &v);
	friend INLINE rmatrix InfRe(const cimatrix_slice &v);
	friend INLINE rmatrix InfIm(const cimatrix_slice &v);
 ...
 template <class MS> friend 	std::istream &_msin(std::istream &s,MS &r);
	...
	explicit INLINE cimatrix_slice(cimatrix &a,const int &l1,const int &u1,const int &l2, const int &u2):dat(a.dat),offset1(l1-a.lb1),offset2(l2-a.lb2),mxsize(a.xsize),mysize(a.ysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	//! Constructor of class cimatrix_slice
	explicit INLINE cimatrix_slice(cimatrix_slice &a,const int &l1,const int &u1,const int &l2, const int &u2):dat(a.dat),offset1(a.offset1+l1-a.start1),offset2(a.offset2+l2-a.start2),mxsize(a.mxsize),mysize(a.mysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	public: 
	//! Constructor of class cimatrix_slice
	INLINE cimatrix_slice(const cimatrix_slice &ms):dat(ms.dat),offset1(ms.offset1),offset2(ms.offset2),mxsize(ms.mxsize),mysize(ms.mysize),start1(ms.start1),end1(ms.end1),start2(ms.start2),end2(ms.end2),sxsize(ms.sxsize),sysize(ms.sysize) { }
	public:
	...
	;
#endif
	friend INLINE cimatrix::cimatrix(const cimatrix_slice &);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const cinterval &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const real &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const interval &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const complex &r);
	//! Implementation of standard assigning operator
	...
	//! Operator for accessing the whole matrix
	INLINE cimatrix_slice &operator ()() { return *this; }
	//! Operator for accessing a part of the matrix
	INLINE cimatrix_slice operator ()(const int &m, const int &n)
#if(CXSC_INDEX_CHECK)
	;
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const cinterval &c);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const cinterval &c);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const cinterval &c);
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const real &c);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const real &c);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const real &c);
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const complex &c);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const complex &c);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const complex &c);
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const interval &c);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const interval &c);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const interval &c);
...
//=======================Vector / Scalar =========================
	...
	INLINE civector operator /(const cimatrix_subv &rv, const cinterval &s);
	//! Implementation of multiplication operation
	INLINE civector operator *(const cimatrix_subv &rv, const cinterval &s);
	//! Implementation of multiplication operation
	INLINE civector operator *(const cinterval &s, const cimatrix_subv &rv);
	//! Returns the absolute value of the matrix
	INLINE ivector abs(const cimatrix_subv &mv);
	//! Returns the diameter of the matrix
	INLINE cvector diam(const cimatrix_subv &mv);
	//! Returns the middle of the matrix
	INLINE cvector mid(const cimatrix_subv &mv);
	//! Returns the infimum of the matrix
	INLINE cvector Inf(const cimatrix_subv &mv);
	//! Returns the supremum of the matrix
	INLINE cvector Sup(const cimatrix_subv &mv);
	//! Returns the imaginary part of the matrix
	INLINE ivector Im(const cimatrix_subv &mv);
	//! Returns the real part of the matrix
	INLINE ivector Re(const cimatrix_subv &mv);
	//! Returns the supremum of real part of the matrix
	INLINE rmatrix SupRe(const cimatrix &v);
	//! Returns the supremum of imaginary part of the matrix
	INLINE rmatrix SupIm(const cimatrix &v);
	//! Returns the infimum of real part of the matrix
	INLINE rmatrix InfRe(const cimatrix &v);
	//! Returns the infimum of imaginary part of the matrix
	INLINE rmatrix InfIm(const cimatrix &v);
	//! Returns the supremum of real part of the matrix
	INLINE rmatrix SupRe(const cimatrix_slice &v);
	//! Returns the supremum of imaginary part of the matrix
	INLINE rmatrix SupIm(const cimatrix_slice &v);
	//! Returns the infimum of real part of the matrix
	INLINE rmatrix InfRe(const cimatrix_slice &v);
	//! Returns the infimum of imaginary part of the matrix
	INLINE rmatrix InfIm(const cimatrix_slice &v);
	...
	//! Returns the matrix with the new given supremum value
	INLINE cimatrix_subv &SetSup(cimatrix_subv &iv,const complex &r);
	//! Returns the matrix with the new given infimum value
	INLINE cimatrix_subv &SetInf(cimatrix_subv &iv,const complex &r);
	//! Returns the matrix with the new unchecked given supremum value
	INLINE cimatrix_subv &UncheckedSetSup(cimatrix_subv &iv,const complex &r);
	//! Returns the matrix with the new unchecked given infimum value
	INLINE cimatrix_subv &SetUncheckedInf(cimatrix_subv &iv,const complex &r);
	//! Sets componentwise the real parts of the matrix
	INLINE cimatrix_subv &SetRe(cimatrix_subv &iv,const interval &r);
	//! Sets componentwise the imaginary parts of the matrix
	INLINE cimatrix_subv &SetIm(cimatrix_subv &iv,const interval &r);
...
//===================== Matrix Functions =============================
	...
	INLINE cimatrix _imatrix(const cimatrix &rm);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cimatrix _imatrix(const civector &v);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cimatrix _imatrix(const civector_slice &v);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cimatrix _imatrix(const cinterval &r);
	...
	//! Returns the absolute value of the matrix
	INLINE imatrix abs(const cimatrix &m);
	//! Returns the absolute value of the matrix
	INLINE imatrix abs(const cimatrix_slice &ms);
	//! Returns the rounded diameter of the matrix
	INLINE cmatrix diam(const cimatrix &m);
	//! Returns the rounded diameter of the matrix
	INLINE cmatrix diam(const cimatrix_slice &m);
	//! Returns the rounded middle of the matrix
	INLINE cmatrix mid(const cimatrix &m);
	//! Returns the rounded middle of the matrix
	INLINE cmatrix mid(const cimatrix_slice &m);
	//! Returns the infimum of the matrix
	INLINE cmatrix Inf(const cimatrix &m);
	//! Returns the supremum of the matrix
	INLINE cmatrix Sup(const cimatrix &m);
	//! Returns the infimum of the matrix
	INLINE cmatrix Inf(const cimatrix_slice &m);
	//! Returns the supremum of the matrix
	INLINE cmatrix Sup(const cimatrix_slice &m);
	//! Returns the matrix with the new given infimum value
	...
	//! Returns the imaginary part of the matrix
	INLINE imatrix Im(const cimatrix &m);
	//! Returns the real part of the matrix
	INLINE imatrix Re(const cimatrix &m);
	//! Returns the imaginary part of the matrix
	INLINE imatrix Im(const cimatrix_slice &m);
	//! Returns the real part of the matrix
	INLINE imatrix Re(const cimatrix_slice &m);
	//! Sets componentwise the imaginary parts of the matrix
...
//===================== Matrix / Scalar ===============================
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cimatrix &m);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cimatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const cinterval &c);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const cinterval &c);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const cinterval &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const cinterval &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const cinterval &c);
...
//------------ real - cimatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const real &c, const cimatrix &m);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const real &c, const cimatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const real &c);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const real &c);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const real &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const real &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const real &c);
...
//----------------- rmatrix - cinterval ----------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const rmatrix &m);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const rmatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const rmatrix &m,const cinterval &c);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const rmatrix_slice &ms,const cinterval &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const rmatrix &m,const cinterval &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const rmatrix_slice &ms, const cinterval &c);
...
//------------ complex - cimatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const complex &c, const cimatrix &m);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const complex &c, const cimatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const complex &c);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const complex &c);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const complex &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const complex &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const complex &c);
...
//----------------- cmatrix - cinterval ----------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cmatrix &m);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cmatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cmatrix &m,const cinterval &c);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cmatrix_slice &ms,const cinterval &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cmatrix &m,const cinterval &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cmatrix_slice &ms, const cinterval &c);
...
//------------ interval - cimatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const interval &c, const cimatrix &m);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const interval &c, const cimatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const interval &c);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const interval &c);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const interval &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const interval &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const interval &c);
...
//----------------- imatrix - cinterval ----------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const imatrix &m);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const imatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const imatrix &m,const cinterval &c);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const imatrix_slice &ms,const cinterval &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const imatrix &m,const cinterval &c);
	//! Implementation of division operation
	INLINE cimatrix operator /(const imatrix_slice &ms, const cinterval &c);
...
//================ Matrix / Matrix ============================
	...
	INLINE const cimatrix &operator +(const cimatrix &m1);
	//! Implementation of positive sign operation
	INLINE cimatrix operator +(const cimatrix_slice &ms);
	//! Implementation of addition operation
...
//-------------- Matrix - Matrix   -------------------------
	...
	INLINE bool operator ==(const cimatrix &m1,const cimatrix &m2);
	...
	INLINE bool operator >=(const cimatrix &m1,const cimatrix &m2);
	//! Implementation of standard equality operation
	INLINE bool operator ==(const cimatrix &m1,const cimatrix_slice &ms);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const cimatrix &m1,const cimatrix_slice &ms);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const cimatrix &m1,const cimatrix_slice &ms);
...
//---------------- Matrix - Matrix_slice ----------------------
	...
	//! Implementation of standard equality operation
	INLINE bool operator ==(const cimatrix_slice &m1,const cimatrix_slice &m2);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const cimatrix_slice &m1,const cimatrix_slice &m2);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const cimatrix_slice &m1,const cimatrix_slice &m2);
...
//=================== Not Operator =============================
	...
	INLINE bool operator !(const cimatrix &ms);
	//! Implementation of standard negation operation
	INLINE bool operator !(const cimatrix_slice &ms);

//======================== Input / Output ========================

	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const cimatrix &r);
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const cimatrix_slice &r);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,cimatrix &r);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,cimatrix_slice &r);
