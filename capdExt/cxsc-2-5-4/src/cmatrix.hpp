...
template <class V,class MV> friend  V &_vmvusetsup(V &rv,const MV &v)
	...
	explicit INLINE cmatrix_subv (complex *d, const int &l, const int &u, const int &s, const int &st, const int &o):dat(d),lb(l),ub(u),size(s),start(st),offset(o) { }
        public:
	//! Constructor of class cmatrix_subv
	INLINE cmatrix_subv(const cmatrix_subv &v):dat(v.dat),lb(v.lb),ub(v.ub),size(v.size),start(v.start),offset(v.offset) { }
	public:

	//---------------------- Standardfunktionen ------------------------
	//! Returns the lower bound of the vector
	friend INLINE int Lb(const cmatrix_subv &rv) { return rv.lb; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const cmatrix_subv &rv) { return rv.ub; }
	//! Returns the size of the vector
	friend INLINE int VecLen(const cmatrix_subv &rv) { return rv.size; }
	...
	INLINE cmatrix_subv &operator ()() { return *this; }
	...
	//! Implementation of standard assigning operator
	INLINE cmatrix_subv &operator =(const cmatrix_subv &rv);
	//! Implementation of standard assigning operator
	INLINE cmatrix_subv &operator =(const complex &r);
	//! Implementation of standard assigning operator
	...
	INLINE cmatrix_subv &operator *=(const complex &c);
	...
	// Real
	//! Implementation of standard assigning operator
	INLINE cmatrix_subv &operator =(const rmatrix_subv &rv);
	//! Implementation of standard assigning operator
	INLINE cmatrix_subv &operator =(const real &r);
	//! Implementation of standard assigning operator
	...
	//! Implementation of multiplication and allocation operation
	INLINE cmatrix_subv &operator *=(const real &c);
	//! Implementation of addition and allocation operation
	INLINE cmatrix_subv &operator +=(const real &c);
	//! Implementation of subtraction and allocation operation
	INLINE cmatrix_subv &operator -=(const real &c);
...
// complex
	...
	INLINE cmatrix(const cmatrix &rm);
	//! Constructor of class cmatrix
	INLINE cmatrix(const cmatrix_slice &rm);
	//! Constructor of class cmatrix
...
#endif
	//! Constructor of class cmatrix
	explicit INLINE cmatrix(const cvector &v);
	//! Constructor of class cmatrix
	explicit INLINE cmatrix(const cvector_slice &v);
	//! Constructor of class cmatrix
	explicit INLINE cmatrix(const complex &r);
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const complex &r);
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const cmatrix &m);
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const cmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const scmatrix &m);
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const scmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const cvector &v);
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const cvector_slice &v);
//  real
	//! Constructor of class cmatrix
	explicit INLINE cmatrix(const real &);
	//! Constructor of class cmatrix
	explicit INLINE cmatrix(const rmatrix &rm);
	//! Constructor of class cmatrix
	explicit INLINE cmatrix(const rmatrix_slice &rm);
	//! Constructor of class cmatrix
	explicit INLINE cmatrix(const srmatrix &rm);
	//! Constructor of class cmatrix
	explicit INLINE cmatrix(const srmatrix_slice &rm);
	//! Constructor of class cmatrix
	explicit INLINE cmatrix(const rvector &v);
	//! Constructor of class cmatrix
	explicit INLINE cmatrix(const rvector_slice &v);
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const real &r);
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const rmatrix &m);
	//! Implementation of standard assigning operator
	...
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const rvector &v);
	//! Implementation of standard assigning operator
	INLINE cmatrix &operator =(const rvector_slice &v);

	//--------------------------- Destruktoren -----------------------------

	INLINE ~cmatrix() { delete [] dat; }
...
template <class V,class MS,class S> friend void _vmsconstr(V &v,const MS &m)
 ...
 template <class MS1,class MS2> friend 	 MS1 &_msmssectassign(MS1 &ms1,const MS2 &ms2)
  ...
  /*   friend TINLINE civector &_vsmscimultassign<civector_slice,cmatrix_slice,cinterval>(civector_slice &v,const cmatrix_slice &ms)
	...
	explicit INLINE cmatrix_slice(cmatrix &a,const int &l1,const int &u1,const int &l2, const int &u2):dat(a.dat),offset1(l1-a.lb1),offset2(l2-a.lb2),mxsize(a.xsize),mysize(a.ysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	//! Constructor of class cmatrix_slice
	explicit INLINE cmatrix_slice(cmatrix_slice &a,const int &l1,const int &u1,const int &l2, const int &u2):dat(a.dat),offset1(a.offset1+l1-a.start1),offset2(a.offset2+l2-a.start2),mxsize(a.mxsize),mysize(a.mysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	public: 
	//! Constructor of class cmatrix_slice
	INLINE cmatrix_slice(const cmatrix_slice &ms):dat(ms.dat),offset1(ms.offset1),offset2(ms.offset2),mxsize(ms.mxsize),mysize(ms.mysize),start1(ms.start1),end1(ms.end1),start2(ms.start2),end2(ms.end2),sxsize(ms.sxsize),sysize(ms.sysize) { }
	public:
	...
	;
#endif
	friend INLINE cmatrix::cmatrix(const cmatrix_slice &);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cmatrix_slice &operator =(const complex &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cmatrix_slice &operator =(const real &r);
	//! Implementation of standard assigning operator
...
#endif
	//! Operator for accessing the whole matrix
	INLINE cmatrix_slice &operator ()() { return *this; }
	//! Operator for accessing a part of the matrix
	INLINE cmatrix_slice operator ()(const int &m, const int &n)
#if(CXSC_INDEX_CHECK)
	;
...
#endif
	//! Implementation of multiplication and allocation operation
	INLINE cmatrix_slice &operator *=(const complex &c);
	//! Implementation of multiplication and allocation operation
	INLINE cmatrix_slice &operator *=(const real &c);
	//! Implementation of division and allocation operation
	INLINE cmatrix_slice &operator /=(const complex &c);
	//! Implementation of division and allocation operation
	INLINE cmatrix_slice &operator /=(const real &c);
...
//=======================Vector / Scalar =========================
	...
	INLINE cvector operator /(const cmatrix_subv &rv, const complex &s);
	//! Implementation of multiplication operation
	INLINE cvector operator *(const cmatrix_subv &rv, const complex &s);
	//! Implementation of multiplication operation
	INLINE cvector operator *(const complex &s, const cmatrix_subv &rv);

//======================== Vector / Vector ========================
	
	//! Returns the absolute value of the matrix
	INLINE rvector abs(const cmatrix_subv &mv);
	//! Returns the imaginary part of the matrix
	INLINE rvector Im(const cmatrix_subv &mv);
	//! Returns the real part of the matrix
	INLINE rvector Re(const cmatrix_subv &mv);
...
#endif
	//! Sets componentwise the real parts of the matrix
	INLINE cmatrix_subv &SetRe(cmatrix_subv &iv,const real &r);
	//! Sets componentwise the imaginary parts of the matrix
	INLINE cmatrix_subv &SetIm(cmatrix_subv &iv,const real &r);
...
//===================== Matrix Functions =============================
	...
	INLINE cmatrix _cmatrix(const cmatrix &rm);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cmatrix _cmatrix(const cvector &v);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cmatrix _cmatrix(const cvector_slice &v);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cmatrix _cmatrix(const complex &r);
	...
	//! Returns the absolute value of the matrix
	INLINE rmatrix abs(const cmatrix &m);
	//! Returns the absolute value of the matrix
	INLINE rmatrix abs(const cmatrix_slice &ms);
	//! Returns the imaginary part of the matrix
	INLINE rmatrix Im(const cmatrix &m);
	//! Returns the real part of the matrix
	INLINE rmatrix Re(const cmatrix &m);
	//! Returns the imaginary part of the matrix
	INLINE rmatrix Im(const cmatrix_slice &m);
	//! Returns the real part of the matrix
	INLINE rmatrix Re(const cmatrix_slice &m);
	//! Sets componentwise the imaginary parts of the matrix
...
//===================== Matrix / Scalar ===============================
	...
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const complex &c, const cmatrix &m);
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const complex &c, const cmatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const cmatrix &m,const complex &c);
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const cmatrix_slice &ms,const complex &c);
	//! Implementation of multiplication and allocation operation
	INLINE cmatrix &operator *=(cmatrix &m,const complex &c);
	//! Implementation of division operation
	INLINE cmatrix operator /(const cmatrix &m,const complex &c);
	//! Implementation of division operation
	INLINE cmatrix operator /(const cmatrix_slice &ms, const complex &c);
...
//------------ real - cmatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const real &c, const cmatrix &m);
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const real &c, const cmatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const cmatrix &m,const real &c);
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const cmatrix_slice &ms,const real &c);
	//! Implementation of multiplication and allocation operation
	INLINE cmatrix &operator *=(cmatrix &m,const real &c);
	//! Implementation of division operation
	INLINE cmatrix operator /(const cmatrix &m,const real &c);
	//! Implementation of division operation
	INLINE cmatrix operator /(const cmatrix_slice &ms, const real &c);
...
//----------------- rmatrix - complex ----------------
	...
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const complex &c, const rmatrix &m);
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const complex &c, const rmatrix_slice &ms);
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const rmatrix &m,const complex &c);
	//! Implementation of multiplication operation
	INLINE cmatrix operator *(const rmatrix_slice &ms,const complex &c);
	//! Implementation of division operation
	INLINE cmatrix operator /(const rmatrix &m,const complex &c);
	//! Implementation of division operation
	INLINE cmatrix operator /(const rmatrix_slice &ms, const complex &c);
...
//================ Matrix / Matrix ============================
	...
	INLINE const cmatrix &operator +(const cmatrix &m1);
	//! Implementation of positive sign operation
	INLINE cmatrix operator +(const cmatrix_slice &ms);
	//! Implementation of addition operation
...
/*	INLINE bool operator <(const cmatrix &m1,const cmatrix &m2);
	...
	INLINE bool operator >=(const cmatrix &m1,const cmatrix &m2);*/
	//! Implementation of standard equality operation
	INLINE bool operator ==(const cmatrix &m1,const cmatrix_slice &ms);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const cmatrix &m1,const cmatrix_slice &ms);
/*	INLINE bool operator <(const cmatrix &m1,const cmatrix_slice &ms);
	INLINE bool operator <=(const cmatrix &m1,const cmatrix_slice &ms);
...
//---------------- Matrix - Matrix_slice ----------------------
	...
	//! Implementation of standard equality operation
	INLINE bool operator ==(const cmatrix_slice &m1,const cmatrix_slice &m2);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const cmatrix_slice &m1,const cmatrix_slice &m2);
/*	INLINE bool operator <(const cmatrix_slice &m1,const cmatrix_slice &m2);
	INLINE bool operator <=(const cmatrix_slice &m1,const cmatrix_slice &m2);
...
//=================== Not Operator =============================
	...
	INLINE bool operator !(const cmatrix &ms);
	//! Implementation of standard negation operation
	INLINE bool operator !(const cmatrix_slice &ms);

//======================== Input / Output ========================

	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const cmatrix &r);
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const cmatrix_slice &r);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,cmatrix &r);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,cmatrix_slice &r);
