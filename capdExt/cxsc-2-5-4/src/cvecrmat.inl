...
namespace cxsc {
	...
	INLINE cvector::cvector(const rmatrix_subv &v):l(v.lb),u(v.ub),size(v.size)
	{
...
// 	{ _vmvaccu<cidotprecision,cvector,rmatrix_subv>(dp,cvector(rv1),rv2); }
	...
	INLINE cvector &cvector::operator =(const rmatrix_subv &mv) { return _vmvassign<cvector,rmatrix_subv,complex>(*this,mv); }
	INLINE cvector_slice &cvector_slice::operator =(const rmatrix_subv &mv) { return _vsvassign(*this,rvector(mv)); }
