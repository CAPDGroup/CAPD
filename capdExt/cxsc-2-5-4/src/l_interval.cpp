...
l_interval & l_interval::operator= (const l_interval & a)   
{
...
interval::interval(const l_interval & a)
{
...
interval & interval::operator =(const l_interval & a)
{
   idotprecision idot(0.0);
   a._akku_add(idot);
...
/*
l_interval _l_interval(const l_real & a, const l_real & b)
{
   if(a>b)
...
/*
l_interval _unchecked_l_interval(const l_real & lr1, const l_real & lr2)
{
...
idotprecision _idotprecision(const l_interval & a)
{
   return idotprecision(a);
}

idotprecision::idotprecision(const l_interval & a) : inf(0),
                                                             sup(0)
{ 
   a._akku_add(*this);
}

idotprecision & idotprecision::operator =(const l_interval & a)
{
   *this=0;
   a._akku_add(*this);
   return *this;
...
void l_interval::_akku_out(idotprecision& idot)
{  
   // ein im idotakku[0] liegendes Zwischenergebnis
   // wird in der entsprechenden Praezision in das aufrufende l_interval
...
void l_interval::_akku_out_inn(idotprecision& idot)
{ 
   // ein im idotakku[0] liegendes Zwischenergebnis
...
/* void l_interval::_akku_add(idotprecision& d) const
{ 
...
/* void l_interval::_akku_sub(idotprecision& d) const
{ 
...
inline void times2pown(l_interval& x, int n)
