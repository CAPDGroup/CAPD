...
/* CVS $Id: q_glbl.cpp,v 1.20 2014/01/30 17:23:55 cxsc Exp $ */
...
// auf eps(erf) = 4.4262e-16;
 real q_erf_m = 9007199254740986.0 / 9007199254740992.0; // <1
 real q_erf_p = 4503599627370499.0 / 4503599627370496.0; // >1 
...
// Koeffizienten des Kettenbruchs K_4(v) fuer erf(x) in A3=[2^(-30),0.5]:
 ...
 real q_erfa3_b[5] = {4625346952747880.0 / 36028797018963968.0,
...
// Koeffizienten des Kettenbruchs K_7(v) fuer erf_b(x), x in B=[0.5,1.125]:
 real q_erfb_a[8] = {0.0, 
                      2*(6199208649805947.0 / 9007199254740992.0),
                      8973480898155806.0 / 18014398509481984.0,
                      6344938797728080.0 / 72057594037927936.0,
                      8362669583311126.0 / 36028797018963968.0,
                      -5025990561637675.0 / 1152921504606846976.0,
                      6292457919512903.0 / 562949953421312.0,
                      -7287505921801238.0 / 144115188075855872.0 };
 real q_erfb_b[8] = { 6483623493580556.0 / 18014398509481984.0,
                      6333186975989752.0 / 9007199254740992.0,
                      -8475979040581186.0 / 36028797018963968.0,
                      -8572591006893554.0 / 18014398509481984.0,
                      8937293041529414.0 / 36028797018963968.0,
                      -6816417731814578.0 / 2251799813685248.0,
                      8079193748945326.0 / 2251799813685248.0,
                      -7132339039509190.0 / 18014398509481984.0 };
