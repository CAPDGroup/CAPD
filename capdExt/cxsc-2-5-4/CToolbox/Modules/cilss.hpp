...
/* CVS $Id: cilss.hpp,v 1.15 2014/01/30 17:23:38 cxsc Exp $ */
...
/**
 * All versions of the function cilss compute the verified solution of the complex interval linear system AX=B. The variable
...
static inline void  cilss(const cxsc::cimatrix& A, cxsc::cimatrix& B, cxsc::cimatrix& X, int& Err, int K, bool msg=false, int lssparts=LSS_BOTH_PARTS, int threads=-1);
//! Entry function of complex interval linear sytems solver
static inline void  cilss(const cxsc::cimatrix& A, cxsc::civector& B, cxsc::civector& X, int& Err, int K, bool msg=false, int lssparts=LSS_BOTH_PARTS, int threads=-1);

//New versions using struct. Pass an instance of the struct as last parameter to use different than default settings.
//! Entry function of complex interval linear sytems solver
static inline void  cilss(const cxsc::cimatrix& A, cxsc::cimatrix& B, cxsc::cimatrix& X, int& Err, struct lssconfig=lssconfig());
//! Entry function of complex interval linear sytems solver
static inline void  cilss(const cxsc::cimatrix& A, cxsc::civector& B, cxsc::civector& X, int& Err, struct lssconfig=lssconfig());
...
//! Entry function of complex interval linear sytems solver
static inline void  cilss(const cxsc::cimatrix& A, cxsc::cimatrix& B, cxsc::cimatrix& X, cxsc::cimatrix& Y, int& Err, struct lssconfig=lssconfig());
//! Entry function of complex interval linear sytems solver
static inline void  cilss(const cxsc::cimatrix& A, cxsc::civector& B, cxsc::civector& X, cxsc::civector& Y, int& Err, struct lssconfig=lssconfig());
